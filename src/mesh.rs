...
fn create_default_vertex_vec() -> Vec<VertexStruct>{
    let v1 = VertexStruct{position: [-0.5, -0.5, 0.0], normal: [1.0, 0.0, 0.0]};
    let v2 = VertexStruct{position: [0.0, 0.5, 0.0], normal: [1.0, 0.0, 0.0]};
    let v3 = VertexStruct{position: [0.5, -0.25, 0.0], normal: [1.0, 0.0, 0.0]};
    vec![v1, v2, v3]
...
I::IntoIter: ExactSizeIterator {
    CpuAccessibleBuffer::from_iter(gc.device.clone(), BufferUsage::vertex_buffer(), false, data).unwrap()
}
